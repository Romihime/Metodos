...
{
    ////////////////////////////
    //Codigo que levanta el archivo
    //high_resolution_clock::time_point t1 = high_resolution_clock::now();
    //Esto esta conteomplando el formato "archivo p" por mas que el parametro p no se use todavia
    if(argc < 3){
    ...
    if(fs.is_open()){
        while(!fs.eof()){
            ...
            for(int i = 0; i < k; i++){
                ...
                //cout << m << endl;
                // cout << "Cree la matriz" << endl;
                //Aca deberia ir el codigo que trabaje con la matriz
                //Aca tengo matrix w
                ...
                //Aca tengo la matrix d
                // cout << "pase esto" << endl;
               // cout << m << endl;
               // cout << d << endl;

                m.mult_diag(d);
                //Aca tengo la matrix r= wd
 
               // cout << "wd" <<endl;
               // cout << m << endl;

                m.mult_scalar(-p);//(-1*p)
                //Aca tengo la matriz que hay que restarla a la identidad -(p*wd)
                // cout << "paso las multiplicaciones" << endl;
                //cout << m << endl;
                Matrix id(paginas, paginas);
                for(uint i= 0; i < id.RowCount(); i++){
                  id.SetValue(i, i, 1);
                }
                 //Aca tenemos la identidad
                //cout << id << endl;


                id.add(m);
                //Aca quedaria la matrix M = I-pWD
             ...
             /*   cout << "matrix triangulada"<< endl;

                cout << id << endl;
                cout << "vector de unos triangulado" << endl;
                for (int i = 0; i < paginas; ++i){
                   cout << unos[i]<< endl;        
                }     */

                 ///ahora aca resolvemos el sistema de ecuaciones
                vector<double> incognitas =resolucion(id, unos);
    
             /*   cout << "vector de incognitas" << endl;
                for (int i = 0; i < paginas; ++i){
                    cout << incognitas[i]<< endl;        
                }  */   
    
                //Ahora normalizamos el resultado
